 ...
 * 贷款期限
 */
public class PopuHuankuanWay implements OnClickListener,OnWheelChangedListener{

	private static final String TAG = "PopuHuankuanWay";
	private Activity mContext;
	private LayoutInflater mInflater;
	public PopuHuankuanWay(Activity context) {
	...
	public interface ResultListener {
		public void onResult(String name, int value);
	}
	...
	private void confirm() {
		if (null != mResultListener)
			mResultListener.onResult(name, value);
	}
