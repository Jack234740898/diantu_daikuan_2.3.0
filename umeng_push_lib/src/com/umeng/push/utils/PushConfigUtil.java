...
public class PushConfigUtil {
	...
	/*
	 * MyPushIntentService.class
	 */
	public static void init(Context context,Class clazz,boolean isMergeNotificaiton){
		PushAgent mPushAgent = PushAgent.getInstance(context);
		if(!mPushAgent.isEnabled())
			mPushAgent.enable();
		mPushAgent.setDebugMode(false);
		mPushAgent.setPushIntentServiceClass(clazz);
		mPushAgent.setMergeNotificaiton(isMergeNotificaiton);
